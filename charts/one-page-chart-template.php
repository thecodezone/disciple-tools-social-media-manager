...
class Disciple_Tools_Social_Media_Manager_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-social-media-manager-metrics'; // lowercase
    public $base_title = 'Social Media Manager Plugin Metrics';
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    'title' => $this->title,
                    'Sample API Call' => __( 'Sample API Call', 'disciple-tools-social-media-manager' )
                ]
            ]
        );
    }
