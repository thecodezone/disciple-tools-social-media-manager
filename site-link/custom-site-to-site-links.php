...
class Disciple_Tools_Social_Media_Manager_Site_Links {
    public $type = 'disciple_tools_social_media_manager';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Social Media Manager Plugin' );
        return $type;
    }
}
Disciple_Tools_Social_Media_Manager_Site_Links::instance();
