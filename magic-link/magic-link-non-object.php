 ...
 */
class Disciple_Tools_Social_Media_Manager_Magic_Non_Object_App extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
...
Disciple_Tools_Social_Media_Manager_Magic_Non_Object_App::instance();
