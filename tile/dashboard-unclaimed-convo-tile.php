...
*/
class SMM_Unclaimed_Conversation_Tile extends DT_Dashboard_Tile
{
    ...
    public function render() {
        include( trailingslashit( plugin_dir_path( __DIR__ ) ) . 'tile/template/dashboard-unclaimed-convo-template.php' );
    }
}
